    ...
    return (
      <nav className="navbar">
        <div className="menu-icon">
          <span
            className={
              this.state.showNavbar ? "fas fa-bars hide" : "fas fa-bars"
            }
        ...
        <ul
          className={this.state.showNavbar ? "nav-items active" : "nav-items"}
        >
          <li>
          ...
          <li>
            <Link to="./books" onClick={this.closeNavbar}>
        ...
        <div
          className={
            this.state.showNavbar || this.state.showSearchInput
              ? "search-icon hide"
              : "search-icon"
          }
        ...
        >
          <span
            ...
            style={this.state.showSearchInput ? { color: "#ff3d00" } : {}}
          />
        </div>
